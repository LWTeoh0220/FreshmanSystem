...
export const processGraphsData = {
  pre_arrival_luggage: {
    ...
    nodes: [
      ...
      { id: 'lug_3', title: '準備符合臺灣電壓 (110V) 的轉換插頭', description: '大馬電壓是 240V，插頭形狀不同，務必準備轉接頭' }
    ]
  },
  pre_arrival_health: {
    ...
    type: 'checklist',
    nodes: [
      { id: 'hea_1', title: '在大馬當地醫院完成僑外生體檢並拿到 X 光片報告正本', description: '需確保體檢項目符合臺灣衛福部規定' },
      { id: 'hea_2', title: '辦理麻疹及德國麻疹 (MMR) 疫苗接種證明', description: '若無證明則需在臺灣重新施打' }
    ]
  },
  arc_process: {
    id: 'arc_process',
    ...
    nodes: [
      ...
      { id: 'arc_2', title: '辦理臺灣手機門號', description: '攜帶雙證件(護照、入學許可)前往電信局' },
  ...
  sim_process: {
    ...
    title: "申辦臺灣手機門號",
    nodes: [
      { id: "sim_1", title: "攜帶雙證件正本", description: "護照與入臺許可證 (或大學錄取通知書)。" },
      { id: "sim_2", title: "年滿 18 歲確認", description: "若未滿 18 歲需監護人同意書或學校代辦手續。" },
      { id: "sim_3", title: "前往電信門市", description: "尋找校園附近的中華電信、臺灣大哥大或遠傳門市。" },
  ...
  bank_process: {
    ...
    nodes: [
      ...
      { id: 'bank_2', title: '郵局/銀行開戶', description: '攜帶 ARC、印章與新臺幣1000元開戶', isMilestone: true, achievementIcon: 'wallet', achievementName: '財富自由的第一步' }
    ],
    edges: [
  ...
  main_quest: {
    ...
    nodes: [
      ...
      { id: 'mq_phone', title: '【階段二】通訊辦理', description: '辦理臺灣手機門號，確保能接收各種驗證碼。', suggestedTime: '抵臺當日', targetProcessId: null },
      { id: 'mq_arc', title: '【階段三】合法居留', description: '點擊進入詳細流程：申請中華民國居留證 (ARC)。', suggestedTime: '抵臺 15 日內', targetProcessId: 'arc_process' },
...
export const initialDeadlines = [
  ...
  { id: "dl_pre_1", title: "赴臺行李與物資採購", startDate: "2026-05-01T00:00:00+08:00", endDate: "2026-08-20T23:59:59+08:00", priority: "high", processId: "arc_process" },
...
export const sideQuests = [
  {
    id: "sq_1",
    title: "【解鎖數位錢包】",
    description: "在新手村（臺灣）生存，無現金支付是必備技能。將銀行帳戶綁定至 LINE Pay 或街口支付，從此出門只需帶手機。",
    status: "locked",
    requirements: [
      { text: "已開通臺灣銀行帳戶" },
      { 
        ...
        itemTooltip: {
          title: "【道具：臺灣手機門號卡】",
          purpose: "解鎖臺灣各式行動支付、網銀帳戶的關鍵道具。",
          guide: "攜帶護照與居留證/入臺證，前往學校附近的各大電信辦理。新生推薦辦理預付卡或學生專案。"
        }
      }
    ],
  ...
  },
  {
    id: "sq_2",
    title: "【環保勇者：雲端發票】",
    description: "臺灣的發票是可以中獎的！申請手機條碼載具，結帳時出示條碼，發票自動存入雲端，甚至有專屬獎項。",
    status: "available",
    requirements: [
      { text: "下載統一發票兌獎 APP" },
      { text: "完成信箱驗證" }
